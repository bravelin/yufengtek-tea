...
<script>
    ...
    const chartDataProp = `$store.state.${moduleNameSpace}.teaFarmTypeDatas`

    export default {
        name: 'plant-tea-farm',
        computed: {
            ...thisMapState(['teaFarmTypeDatas', 'farmTotalArea'])
        },
        watch: {
        ...
        mounted () {
            ...
            that.$nextTick(() => {
                ...
                const datas = that.$store.state[moduleNameSpace].teaFarmTypeDatas
